...
export const en: TranslationSchema = {
  ...
  pages: {
    ...
    communityDetail: {
      ...
      leave: "Leave",
      openChat: "Open chat",
      chatMembersOnly: "Chat is for members",
      chatMembersOnlyDesc: "Join the community to post in the group chat",
      ...
      eventFailed: "Could not save the event",
      roleCreator: "Creator",
      roleModerator: "Moderator",
      roleMember: "Member",
      banMember: "Remove",
      banned: "Member removed",
      banFailed: "Could not remove the member",
    ...
    profile: {
      ...
      phoneUnverifiedBadge: "Verify your phone",
    },
    user: {
      metaTitle: "Profile — MoDelizM",
      loading: "Loading…",
    ...
    settings: {
      ...
      verificationSummaryTitle: "Verification status",
      verificationSummaryHint:
        "Verify your email and phone by SMS to publish content and use all features.",
      accountReady: "Account verified",
    },
    register: {
    ...
    homeLink: "Home",
    communityWizard: {
      metaTitle: "New community — MoDelizM",
      title: "Create a community",
      subtitle:
        "Four short steps. Any of them can be skipped — a moderator will review the request.",
      needAccessTitle: "Subscription or a verified account required",
      needAccessDesc:
        "Communities can be created by users with an active subscription or a verified account.",
      needAccessAction: "Get a subscription",
      stepAria: "Step {{n}}",
      stepLabel: "Step {{current}} of {{total}}",
      stepBasics: "Basics",
      stepTopics: "Categories",
      stepRules: "Rules and access",
      stepContacts: "Contacts",
      name: "Name",
      description: "Description",
      city: "City",
      cityPlaceholder: "Optional",
      branding: "Avatar and cover",
      brandingHint: "Avatar 480×480 · cover 1400×400 · JPG, PNG, WEBP",
      uploadAvatar: "Upload avatar",
      changeAvatar: "Change avatar",
      uploadCover: "Upload cover",
      changeCover: "Change cover",
      avatarTitle: "Community avatar",
      coverTitle: "Community cover",
      fileFailed: "Could not process the file",
      topicsHint: "You can pick several topics, for example Aviation → RC planes.",
      customCategory: "Custom category",
      customCategoryPlaceholder: "If none of the listed ones fit",
      rules: "Community rules",
      accessOpen: "Open",
      accessOpenHint: "Anyone can join right away",
      accessClosed: "Closed",
      accessClosedHint: "Joining requires an admin's approval",
      telegram: "Telegram",
      website: "Website",
      phone: "Phone",
      back: "Back",
      ...
      alreadyPending: "You already have a request under review",
      submitFailed: "Could not submit the request",
      nameMin: "Name must be at least 3 characters",
      moderationNote: "The community will appear once a moderator approves it.",
      toList: "Back to communities",
    },
  },
};
