...
export const en: TranslationSchema = {
  ...
  pages: {
    ...
    settings: {
      ...
      walletTopupSubmit: "Pay with VTB",
      ...
      walletTopupVtbHint: "Card payments go through VTB Acquiring only. You will return here after payment.",
      walletTopupVtbMissing: "Could not open VTB checkout. Please try again later.",
