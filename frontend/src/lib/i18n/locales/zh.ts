...
export const zh: TranslationSchema = {
  ...
  components: {
    rightCategories: {
      ...
      allShort: "全部",
      directionsCount: "{{count}} 个方向",
      totalOnline: "{{count}} 在线",
    ...
    createPostForm: {
      ...
      channelTextPlaceholder: "给订阅者的{{kind}}文本…",
    ...
    imageUploadGrid: {
      dropzoneTitle: "拖放照片或点击选择",
      dropzoneTitleMobile: "点击或拖放照片",
      dropzoneHint: "JPG、PNG，最大 10 MB · {{current}}/{{max}}",
      mainBadge: "主图",
      makeMain: "设为主图",
      makeMainAria: "设为主图",
      edit: "编辑",
      ...
      moveRightAria: "照片右移",
      menuAria: "照片操作",
      dragHandleAria: "拖动以排序",
      hintFull: "{{current}}/{{max}}。拖动照片或使用菜单排序。第一张为卡片主图。",
      hintMinimal: "{{current}}/{{max}}。拖动照片排序。第一张为卡片主图。",
    },
    postSchedule: {
      publishNow: "立即发布",
      schedule: "定时发布",
  ...
  pages: {
    ...
    feed: {
      ...
      emptyScheduledTitle: "暂无定时发布",
      emptyScheduledDesc: "创建帖子或视频并选择「定时发布」，内容将在指定时间自动出现在动态中。",
    ...
    adDetail: {
      ...
      ownerModeTitle: "您的广告",
      ownerModeDesc: "管理发布、查看统计并编辑内容。",
      ownerModeShort: "所有者模式",
      ownerModerationTitle: "审核中",
      ownerModerationDesc: "广告正在审核，暂不在目录中显示。",
      ownerRejectedTitle: "已拒绝",
      ownerRejectedDesc: "请编辑后重新提交。",
      ownerStatViews: "浏览",
      ownerStatFavorites: "收藏",
      ownerStatMessages: "消息",
      ownerEdit: "编辑广告",
      ownerEditShort: "编辑",
      ownerUnpublish: "下架",
      ownerUnpublishShort: "下架",
      ownerUnpublishConfirm: "下架此广告？它将离开目录，但保留在「我的广告」中。",
      ownerUnpublished: "广告已下架",
      ownerPreviewAsBuyer: "以买家视角查看",
      ownerBoost: "推广广告",
      ownerShare: "分享",
      ownerDelete: "删除广告",
      ownerDeleteConfirm: "删除此广告？可在「我的广告」中恢复。",
      ownerDeleted: "广告已删除",
      ownerActionFailed: "操作失败",
      previewModeTitle: "买家预览",
      previewModeDesc: "其他用户看到的页面效果。",
      previewModeExit: "返回管理模式",
    },
    adsNew: {
