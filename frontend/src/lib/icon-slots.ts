...
export const ICON_SLOTS: IconSlot[] = [
  {
    ...
    group: "nav",
    page: "navigation",
    defaultLucide: "Newspaper",
    defaultToken: "foreground-70",
    previewKind: "nav",
  },
  {
    key: "nav.ads",
    label: "Каталог объявлений",
    group: "nav",
    page: "navigation",
    defaultLucide: "Megaphone",
    defaultToken: "foreground-70",
    previewKind: "nav",
  },
  {
  ...
  },
  {
    ...
    group: "nav",
    page: "navigation",
    defaultLucide: "Settings",
    defaultToken: "foreground-70",
    previewKind: "nav",
  },
  {
    key: "nav.wallet",
    label: "Баланс и история",
    group: "nav",
    page: "navigation",
    defaultLucide: "Wallet",
    defaultToken: "foreground-70",
    previewKind: "nav",
  },
  {
  ...
  },
  {
    ...
    group: "nav",
    page: "navigation",
    defaultLucide: "MessageSquarePlus",
    defaultToken: "foreground-70",
    previewKind: "nav",
  },
  {
    key: "nav.invite-friend",
  ...
  {
    key: "header.messenger",
    label: "Мессенджер (шапка)",
    group: "header",
    page: "navigation",
    defaultLucide: "MessageSquare",
    defaultToken: "foreground-70",
  ...
  {
    key: "landing.value:focus",
    label: "«Только моделизм»",
    group: "landing",
    page: "landing",
    defaultLucide: "Target",
    defaultToken: "accent",
    previewKind: "value",
    supportsRecolor: true,
  },
  {
    key: "landing.value:community",
    label: "«Живое сообщество»",
    group: "landing",
    page: "landing",
    defaultLucide: "HeartHandshake",
    defaultToken: "accent",
    previewKind: "value",
    supportsRecolor: true,
  },
  {
    key: "landing.value:allInOne",
    label: "«Всё в одном месте»",
    group: "landing",
    page: "landing",
    defaultLucide: "LayoutGrid",
    defaultToken: "accent",
    previewKind: "value",
    supportsRecolor: true,
  },
  {
    key: "landing.value:direct",
    label: "«Прямое общение»",
    group: "landing",
    page: "landing",
    defaultLucide: "Send",
    defaultToken: "accent",
  ...
  {
    key: "feed.find-people",
    label: "«Найди своих» — заголовок",
    group: "feed",
    page: "feed",
    defaultLucide: "Users",
    defaultToken: "accent",
