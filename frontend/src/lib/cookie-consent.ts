 ...
 * нет — ни одного запроса к Яндекс.Метрике со страницы не уходит.
 *
 * Про Яндекс вообще этого сказать нельзя, и притворяться не стоит: карта
 * пунктов выдачи тоже его, и она грузится без спроса. Но она функциональная,
 * а не аналитическая — без неё нельзя выбрать пункт и закончить покупку, —
 * и подключается только когда покупатель сам открыл выбор пункта. Согласие
 * в баннере про аналитику и рекламу; служебное, без чего услуга не
 * оказывается, за ним не стоит.
 *
