...
const rawAds: Array<Omit<Ad, "image" | "gallery" | "seller"> & { seeds: number[]; sellerStats: [number, number, string] }> = [
  { id: "a1", title: "Двигатель ДВС Picco .21 для багги 1:8", price: 18000, category: "Автомодели", subcategory: "ДВС", city: "Краснодар", delivery: ["СДЭК", "Почта России"], deliveryDetails: "Отправка в день оплаты, трек предоставляется. Самовывоз в центре Краснодара.", condition: "Б/у", status: "Продаю", contact: "+7 900 000-00-01", authorId: "u1", description: "Двигатель Picco P3 21 в отличном состоянии. Откатан 8 баков, компрессия живая, гильза-поршень без задиров. Свеча новая OS A5. Подходит для багги и трагги класса 1:8. Продаю по причине перехода на электро.", views: 1240, likes: 18, createdAt: "2 часа назад", promoted: true, seeds: [11, 111, 112, 113, 114], sellerStats: [4.9, 47, "март 2022"] },
  ...
  { id: "a3", title: "Аккумулятор LiPo 6S 5000mAh 50C XT90", price: 3200, category: "Аккумуляторы", subcategory: "LiPo", city: "Санкт-Петербург", delivery: ["СДЭК"], deliveryDetails: "Аккумуляторы отправляются только СДЭК (наземкой), без авиа.", condition: "Б/у", status: "Продаю", contact: "tg @rc_spb", authorId: "u3", description: "LiPo 6S2P 5000mAh, 50C, разъём XT90. Использовался один сезон в FPV-квадрокоптере 7\". Циклов ~40, баланс ячеек идеальный (3.85 в покое). Без вздутий.", views: 2150, likes: 34, createdAt: "вчера", seeds: [13, 131, 132, 133, 134], sellerStats: [5.0, 89, "ноябрь 2020"] },
  ...
  { id: "a14", title: "VTX TBS Unify Pro32 HV 5G8", price: 4200, category: "Квадрокоптеры", subcategory: "FPV", city: "Казань", delivery: ["Почта России"], deliveryDetails: "Только Почта, отслеживание включено.", condition: "Б/у", status: "Продаю", contact: "+7 900 000-00-14", authorId: "u6", description: "TBS Unify Pro32 HV, 25/200/500/800мВт. SmartAudio, MMCX. Без сколов, протестирован на стенде.", views: 670, likes: 11, createdAt: "неделю назад", seeds: [34, 341, 342], sellerStats: [4.7, 21, "май 2023"] },
  ...
  { id: "a18", title: "Передатчик FrSky R-XSR (ACCST D16)", price: 1800, category: "Радиоаппаратура", subcategory: "Приёмники", city: "Новосибирск", delivery: ["Почта России"], deliveryDetails: "Отправка по предоплате.", condition: "Б/у", status: "Продаю", contact: "+7 900 000-00-18", authorId: "u4", description: "FrSky R-XSR, прошит на последнюю версию ACCST. Антенны без повреждений.", views: 460, likes: 6, createdAt: "2 недели назад", seeds: [38, 381], sellerStats: [4.9, 64, "февраль 2022"] },
  ...
  { id: "a29", title: "Дрон DJI Avata комбо (Goggles 2 + RC Motion 2)", price: 95000, category: "Квадрокоптеры", subcategory: "Съёмочные", city: "Москва", delivery: ["СДЭК", "Яндекс Доставка"], deliveryDetails: "Полная коробка, чек сохранён, гарантия.", condition: "Б/у", status: "Продаю", contact: "+7 900 000-00-29", authorId: "u2", description: "DJI Avata комбо: дрон, очки Goggles 2, RC Motion 2, 3 батареи, чарджер. Налёт ~6 часов.", views: 4820, likes: 87, createdAt: "месяц назад", seeds: [49, 491, 492, 493, 494], sellerStats: [4.8, 32, "июль 2021"] },
  { id: "a30", title: "Планер EasyGlider 4 с электроприводом", price: 12500, category: "Самолёты", subcategory: "Планеры", city: "Новосибирск", delivery: ["СДЭК"], deliveryDetails: "Только СДЭК, большая коробка.", condition: "Б/у", status: "Продаю", contact: "+7 900 000-00-30", authorId: "u4", description: "Multiplex EasyGlider 4, размах 1.8м, мотор и регулятор установлены. Без электроники RX.", views: 760, likes: 13, createdAt: "2 месяца назад", seeds: [50, 501, 502], sellerStats: [4.9, 64, "февраль 2022"] },
];
...
export const faqItems: FAQItem[] = [
  ...
  { id: "f4", category: "ads", question: "Как разместить объявление?", answer: "Нажмите «Создать» → «Объявление», заполните форму (название, цена, фото), оплатите размещение с баланса или картой и ждите модерации." },
  { id: "f5", category: "ads", question: "Сколько стоит размещение?", answer: "Стоимость берётся из настроек системы. Для подписчиков действует льготная цена размещения." },
