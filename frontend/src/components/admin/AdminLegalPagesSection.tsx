...
export function AdminLegalPagesSection() {
  ...
  const [draft, setDraft] = useState({ slug: "", title: "", content_html: "" });
  ...
  return (
    <div style={{ display: "grid", gap: 16 }}>
      <h2 style={{ fontSize: 18, fontWeight: 700 }}>Юридические страницы</h2>
      ...
      {editing && (
        <div className="rounded-lg border p-4" style={{ borderColor: "var(--border)" }}>
          <div className="mb-3 font-semibold">Редактор: {editing.slug}</div>
