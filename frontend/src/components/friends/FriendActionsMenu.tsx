        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute right-0 top-full z-[var(--z-popover)] mt-[6px] w-[220px] overflow-hidden rounded-[12px] border"
              style={{
            ...
            {open && (
              <>
                ...
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 24 }}
                  transition={{ duration: 0.18, ease: [0.22, 1, 0.36, 1] }}
                  className="fixed inset-x-0 bottom-0 z-[var(--z-modal)] overflow-hidden rounded-t-[16px] border pb-[max(8px,env(safe-area-inset-bottom))]"
                  style={{
                    background: "var(--background-elevated)",
                    borderColor: "var(--border)",
                    boxShadow: "var(--shadow-float)",
