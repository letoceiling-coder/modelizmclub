...
export function CategoryCard({ c }: { c: Category }) {
  ...
  return (
    <Link
      to="/categories/$id"
      params={{ id: c.id }}
      className="group flex flex-col rounded-xl border bg-card p-4 transition hover:border-[var(--accent)] hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
