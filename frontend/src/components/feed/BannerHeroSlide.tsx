      ...
      <div className="absolute inset-0">
        {banner.image ? (
          <Img
            ...
            /*
             * Приоритет — здесь, и это подтверждено замером, а не догадкой.
             *
             * 12.09 я снял его отсюда, решив, что LCP ленты — фотография
             * первой записи. Замер кандидатов сказал обратное: LCP — именно
             * этот баннер (`ef6d4467…/medium.webp`, 54040 px², самый верхний
             * элемент), а фотография записи лежит ниже сгиба на 622 px и
             * кандидатом не становится. Приоритет вернулся туда, где он
             * нужен; у записи он снят в `routes/feed.tsx`, когда баннер есть.
             */
            priority={priority}
            alt=""
