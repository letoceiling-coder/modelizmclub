...
`content-encoding`.~~ **Неверно с 10.09.2026:** тот же запрос возвращает
`content-encoding: br` и 340 983 байта, HTML приходит `gzip`. CSS так же — 161 813 байт. Кэширование при этом настроено
