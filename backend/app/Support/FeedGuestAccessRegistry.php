...
final class FeedGuestAccessRegistry
{
    ...
    public static function actions(): array
    {
        return [
            ...
            ['key' => 'layout.nav.deals', 'group' => 'layout_nav', 'label' => 'Безопасные сделки', 'hint' => 'Пункт меню → /deals', 'default_allowed' => false],
            ...
            ['key' => 'layout.nav.reviews', 'group' => 'layout_nav', 'label' => 'Обзоры', 'hint' => 'Пункт меню → /reviews', 'default_allowed' => false],
            ['key' => 'layout.nav.channels', 'group' => 'layout_nav', 'label' => 'Каналы', 'hint' => 'Пункт меню → /channels', 'default_allowed' => false],
            ...
            ['key' => 'route.deals', 'group' => 'route_guard', 'label' => 'Страница /deals', 'hint' => 'Безопасные сделки', 'default_allowed' => false],
            ['key' => 'route.favorites', 'group' => 'route_guard', 'label' => 'Страница /favorites', 'hint' => 'Избранное', 'default_allowed' => false],
            ['key' => 'route.reviews', 'group' => 'route_guard', 'label' => 'Страница /reviews', 'hint' => 'Обзоры', 'default_allowed' => false],
            ['key' => 'route.channels', 'group' => 'route_guard', 'label' => 'Страница /channels', 'hint' => 'Каналы', 'default_allowed' => false],
