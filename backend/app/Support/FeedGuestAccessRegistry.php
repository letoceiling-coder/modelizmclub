...
final class FeedGuestAccessRegistry
{
    ...
    public static function actions(): array
    {
        $rows = [
            ...
            ['key' => 'route.communities', 'group' => 'route_guard', 'label' => 'Страница /communities', 'hint' => 'Сообщества: список и страница сообщества читаются гостем, действия закрыты своими ключами', 'default_min_tier' => 'guest'],
