...
/**
 * escrow_deals was the YooKassa "safe deal" prototype. It never got a controller,
 * a route or a service — the shipped escrow runs on safe_deals + escrow_transactions
 * (SafeDealService). Dropping the unused table with its model and enum.
 */
